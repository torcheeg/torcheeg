...
SEED_CHANNEL_LOCATION_DICT = format_channel_location_dict(
    SEED_CHANNEL_LIST, SEED_LOCATION_LIST)
...
SEED_ADJACENCY_MATRIX = format_adj_matrix_from_adj_list(SEED_CHANNEL_LIST,
                                                        SEED_ADJACENCY_LIST)

SEED_STANDARD_ADJACENCY_MATRIX = format_adj_matrix_from_standard(
    SEED_CHANNEL_LIST, STANDARD_1005_CHANNEL_LOCATION_DICT)

SEED_GENERAL_REGION_LIST = format_region_channel_list(SEED_CHANNEL_LIST,
                                                      GENERAL_REGION_LIST)
SEED_FRONTAL_REGION_LIST = format_region_channel_list(SEED_CHANNEL_LIST,
                                                      FRONTAL_REGION_LIST)
SEED_HEMISPHERE_REGION_LIST = format_region_channel_list(
    SEED_CHANNEL_LIST, HEMISPHERE_REGION_LIST)