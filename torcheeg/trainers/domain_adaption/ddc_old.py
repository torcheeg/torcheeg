...
class DDCTrainer(ClassificationTrainer):
    ...
    Args:
        ...
        lambd (float): The weight of DDC loss to trade-off between the classification loss and DDC loss. (default: :obj:`1.0`)
        adaption_factor (bool): Whether to adjust the cross-domain-related loss term using the fitness factor, which was first proposed in DANN but works in many cases. (default: :obj:`False`)
