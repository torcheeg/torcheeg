...
class DDPMTrainer(BasicTrainer):
    ...
    Args:
        ...
        beta_start: (float): The start point of the linear beta scheduler to sample betas. (default: :obj:`1e-4`)
        beta_end: (float): The end point of the linear beta scheduler to sample betas. (default: :obj:`2e-2`)
