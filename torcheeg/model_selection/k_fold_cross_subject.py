...
class KFoldCrossSubject:
    ...
    Args:
        ...
        split_path (str): The path to data partition information. If the path exists, read the existing partition from the path. If the path does not exist, the current division method will be saved for next use. (default: :obj:`./split/k_fikd_cross_subject`)
    '''
    def __init__(self,
                 n_splits: int = 5,
                 shuffle: bool = False,
                 random_state: Union[None, int] = None,
                 split_path: str = '.torcheeg/split/k_fikd_cross_subject'):
