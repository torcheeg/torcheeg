...
class KFoldPerSubject:
    ...
    def split_info_constructor(self, info: pd.DataFrame) -> None:
        ...
        for subject in subjects:
            ...
            for i, (train_index, test_index) in enumerate(self.k_fold.split(subject_info)):
                train_info = subject_info.iloc[train_index]
                test_info = subject_info.iloc[test_index]

                train_info.to_csv(os.path.join(self.split_path, f'train_subject_{subject}_fold_{i}.csv'), index=False)
                test_info.to_csv(os.path.join(self.split_path, f'test_subject_{subject}_fold_{i}.csv'), index=False)
