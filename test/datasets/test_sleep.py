...
from torcheeg.datasets import SleepEDFDataset
...
class TestSleepEDFDataset(unittest.TestCase):
    ...
    def test_tsu_benchmark_dataset(self):
        ...
        dataset = SleepEDFDataset(io_path=io_path,
                                      root_path=root_path,
        ...
        self.assertEqual(last_item[0].shape, (4, 3000))
