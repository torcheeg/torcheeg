...
In this example, we demonstrate how to utilize

1. Datasets and transformers in TorchEEG
2. Data partitioning in TorchEEG
3. Models and trainers in TorchEEG

to accomplish a deep learning workflow.
